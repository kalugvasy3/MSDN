...
Class DataCommon
    ...
    ' https://code.msdn.microsoft.com/windowsapps/DataCommon-Class-Access-to-95b43838

    Private gedSQLTimeOut As Integer = CInt(System.Configuration.ConfigurationManager.AppSettings.Item("SQLTimeout"))
    Private connectionString As String = System.Configuration.ConfigurationManager.ConnectionStrings("connectionStr").ConnectionString
    Private providerName As String = System.Configuration.ConfigurationManager.ConnectionStrings("connectionStr").ProviderName
